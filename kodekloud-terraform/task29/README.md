...
A S3 bucket named datacenter-bck-12531 already exists.

1) Copy the contents of datacenter-bck-12531 S3 bucket to /opt/s3-backup/ directory on terraform-client host (the landing host once you load this lab).

2) Delete the S3 bucket datacenter-bck-12531.
